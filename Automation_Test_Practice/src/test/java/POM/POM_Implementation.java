...
public class POM_Implementation {
	...
	By searchsuggestion=By.linkText("Book");
    ...
    By Errorcode500=By.linkText("Errorcode 500");
	...
	public void Name_Element(String fname) throws InterruptedException {
		...
		WebElement firstname = wait.until(ExpectedConditions.elementToBeClickable(fnamefield));
		...
		sortedlist.selectByVisibleText("Rabbit");
		...
		thirdstartdate.sendKeys("11-06-2026");

		Thread.sleep(3000);

		WebElement thirdenddate = driver.findElement(datepicker3enddate);

		thirdenddate.sendKeys("25-06-2026");
	...
	public void upload() throws InterruptedException {
		...
		singlefile.sendKeys("C:\\Users\\SOWMITHRAN\\OneDrive\\ドキュメント\\Book1.xlsx");
		...
		multiplefiles.sendKeys("C:\\Users\\SOWMITHRAN\\OneDrive\\ドキュメント\\Book1.xlsx" +
		"\n" + "C:\\Users\\SOWMITHRAN\\OneDrive\\ドキュメント\\DataProvider.xlsx");
	...
	public void page_table() throws InterruptedException {
      ...
      driver.findElement(checkbox13).click();
		
		Thread.sleep(3000);
		
      driver.findElement(checkbox14).click();
     ...
     driver.findElement(checkbox16).click();
   ...
   driver.findElement(checkbox18).click();
		
		Thread.sleep(3000);
		
   driver.findElement(checkbox19).click();
...
public void slider() throws InterruptedException {
	...
	e.dragAndDropBy(point1, 40, 0).perform();
...
public void broken_links() throws InterruptedException, IOException {
	...
	WebElement title6=driver.findElement(Errorcode500);
